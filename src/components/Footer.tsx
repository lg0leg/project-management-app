...
export default function Footer() {
  ...
  return (
    <footer className="flex min-h-[80px] flex-col items-center justify-around gap-[40px] bg-slate-100 p-[20px] text-2xl text-blue-500 sm:flex-row sm:gap-[0px]">
      ...
      <ul className=" flex flex-col gap-[10px] text-center sm:flex-row sm:gap-[30px]">
        <li className="flex items-center gap-[5px] transition duration-300 hover:text-amber-400">
          <SlSocialGithub />
